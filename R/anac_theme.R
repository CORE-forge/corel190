...
#' It's free, has tolerable kerning pairs and multiple weights. It's actually the official font
#' for italian governament agencies.
#'
#' @md
...
#' }
theme_anac <- function(base_family = "Titillium Web", base_size = 11.5,
                       ...
                       grid_col = "#266FB6", grid = TRUE,
                       axis_col = "#266FB6", axis = FALSE, ticks = FALSE) {
...
import_titillium_web <- function() {
  tw_font_dir <- system.file("fonts", "Titillium_Web", package = "corel190")
}
